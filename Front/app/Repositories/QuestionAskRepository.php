...
class QuestionAskRepository {
	...
	public function getAlldata($arraydata){
		...
		return $string->where('cm_questionask.isflag','1')->where('cm_question_1class.isflag','1')->orderBy('cm_questionask.qc_id','ASC')->orderBy('cm_questionask.last_update_date','DASC')->select('cm_question_1class.qc_name','cm_questionask.*')->get();
	}
	...
	public function getBBINData($arraydata){
		...
		return $string->where('cm_questionask.qa_type',1)->where('cm_questionask.isflag','1')->where('cm_question_1class.isflag','1')->orderBy('cm_questionask.qc_id','ASC')->orderBy('cm_questionask.last_update_date','DASC')->select('cm_question_1class.qc_name','cm_questionask.*')->get();
	}
	...
	public function getBBOSData($arraydata){
		...
		return $string->where('cm_questionask.qa_type',2)->where('cm_questionask.isflag','1')->where('cm_question_1class.isflag','1')->orderBy('cm_questionask.qc_id','ASC')->orderBy('cm_questionask.last_update_date','DASC')->select('cm_question_1class.qc_name','cm_questionask.*')->get();
	}
