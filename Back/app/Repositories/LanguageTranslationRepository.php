...
class LanguageTranslationRepository {
	...
	public function getAlldata($arraydata){
		...
		return $string->where('cm_languagetranslation.isflag','1')->orderBy('cm_languagetranslation.lp_id','ASC')->orderBy('cm_languagetranslation.last_update_date','DESC')->select('cm_language_1product.lp_name','cm_language_2platform.lpf_name','cm_language_3class.lc_name','cm_language_4subclass.lsc_name','cm_languagetranslation.*')->get();
	}
