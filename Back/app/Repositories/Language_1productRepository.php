...
class Language_1productRepository {
	...
	public function getDataByRequestData($arraydata){
		$string = Language_1product::leftjoin('cm_language_2platform','cm_language_1product.lp_id','cm_language_2platform.lp_id')->leftjoin('cm_language_3class','cm_language_2platform.lpf_id','cm_language_3class.lpf_id')->leftjoin('cm_language_4subclass','cm_language_3class.lc_id','cm_language_4subclass.lc_id');
		if($arraydata['lp_id']){
