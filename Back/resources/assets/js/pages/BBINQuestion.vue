		    ...
		    <div class="content list">
		    	<div class="search_block">
                    <div class="search_content">
                        ...
                        <input type="text" class="search_input" placeholder="輸入關鍵字查詢" name="qa_content" @input="search()" @compositionstart="listen_input_start()" @compositionend="listen_input_end()" :value=search_condition.qa_content v-bind:class="{ 'notFound': list_questions.length == 0}">
                    </div>
        ...
        search: function () {
            ...
            setTimeout(function(){
                if(self.composing){
                    ...
                    axios.post('/questions/BBIN', self.search_condition)
                        .then(function (response) {
                            self.questions = response.data;
                            self.all = Math.ceil(self.questions.length / self.limit);
                            self.number = self.questions.length;
