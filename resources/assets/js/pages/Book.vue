        ...
        <div v-else-if="url_show_block == 'language-list'" class="container-main language-style">
            <div v-if="page == 'list'">
                ...
                <div class="container-filter">
                    ...
                    <div class="input-searchType">
                        <div class="searchType-label">
                            <label>
                                <input v-model="lang.search_condition.search_type" type="checkbox" name="language_search_type" @click="search()" >
                                <span>精準搜尋</span>
                            </label>
                        </div>
                    </div>
                        ...
                        <table class="lang-table" v-if="list_languages.length != 0">
                            ...
                            <tbody>
                                <tr v-for="data in list_languages">
                                    ...
                                    <td class="t_project_style" v-if="lang.field_display.product">{{data.lp_name}}</td>
	...
	data() {
        return {
            ...
            lang:{//放置語系的資料
                ...
                expanded: [],
                checked: [],
                search_condition: {'search_type':false}, // 查詢關鍵字 // false 模糊搜尋 、 true 精準搜尋
                keyword:'', // 關鍵字查詢
    ...
    methods: {
        ...
        initLanguageSetting:function(){
            ...
            if(self.lang.save_search_data.use){
                ...
                self.lang.field_lsc = [];
                self.getLanguageProductField();
                self.lang.search_condition = {'search_type':false};
                self.lang.keyword = '';
            }
        },
        // 初始化欄位頁面相關設定
